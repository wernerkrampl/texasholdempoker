...
class TestStraight_flush(unittest.TestCase):
    def setUp(self):
        self.hand_1 = Straight_flush(Hand_table_generator.generate_hand_table([Card('Clubs',4),\
                            Card('Clubs',3),\
                            Card('Clubs',5),\
                            Card('Clubs',2),\
                            Card('Clubs',14)]))

        self.hand_2 = Straight_flush(Hand_table_generator.generate_hand_table([Card('Diamonds', 13),\
                            Card('Diamonds', 11),\
                            Card('Diamonds', 10),\
                            Card('Diamonds', 12),\
                            Card('Diamonds', 14)]))

        self.hand_3 = Straight_flush(Hand_table_generator.generate_hand_table([Card('Spades', 3), \
                            Card('Spades', 4), \
                            Card('Spades', 5), \
                            Card('Spades', 2), \
                            Card('Spades', 14)]))
